...
describe("queues:list command", () => {
  ...
  describe("successful queue listing", () => {
    it("should list multiple queues successfully", function () {
      return test
        .stdout()
        .do(() => {
    ...
    it("should handle queues with no stats gracefully", function () {
      return test
        .stdout()
        .do(() => {
  ...
  describe("error handling", () => {
    ...
    it("should handle errors in JSON format when --json flag is used", function () {
      return test
        .stdout()
        .do(() => {
        ...
        .command(["queues:list", "--json"])
        .it(
          "should handle errors in JSON format when --json flag is used",
          (ctx) => {
            const result = JSON.parse(ctx.stdout);
  ...
  describe("large datasets and pagination", () => {
    it("should handle large datasets correctly", function () {
      return test
        .stdout()
        .do(() => {
    ...
    it("should handle empty list in JSON format", function () {
      return test
        .stdout()
        .do(() => {
