...
describe("rooms:reactions:subscribe command", () => {
  ...
  standardHelpTests("rooms:reactions:subscribe", import.meta.url);
  standardArgValidationTests("rooms:reactions:subscribe", import.meta.url, {
    requiredArgs: ["test-room"],
  });
  standardFlagTests("rooms:reactions:subscribe", import.meta.url, ["--json"]);
