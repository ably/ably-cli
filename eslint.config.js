...
export default [
  ...
  },
  {
    ...
    rules: {
      ...
      // unicorn v64→v73: new rules enabled by recommended — disable until addressed in follow-up
      // Bug: logical-assignment-operators has invalid defaultOptions in unicorn 73.0.0
      // (fixed upstream in https://github.com/sindresorhus/eslint-plugin-unicorn/issues/3317)
